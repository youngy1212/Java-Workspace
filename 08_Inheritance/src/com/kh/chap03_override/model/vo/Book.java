...
public class Book /*extend Object*/{
	...
	/*
	 * 오버라이딩
	 * - 상속받고 있는 부모클래스의 메소드 자식 클래스에서 재정의(재작성)하는 것
	 ...
	 *   ex) 만약 부모메소드의 접근제한자가 protected라면 자식은 public, protected여야함.
	 * - 부모메소드의 예외와 같거나 갯수를 줄여야 한다.
	 ...
	 *  > 혹시라도 부모메소드가 나중에 수정되었을 경우 오류를 알려주기 떄문에 검토할 수 있게 유도한다.
	 *  > 이 메소드가 오버라이딩된 메소드라는걸 알라고자 하는 목적. ★
	 * 
	 */
