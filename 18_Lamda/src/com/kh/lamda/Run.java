...
public class Run {
	...
	/*
	 * 람다식이란? 익명함수(제목이 없는 함수)처럼 구동됨 (JAVA8버전 이후)
	...
	public static void main(String[] args) {
		lamda l;
		l =() -> {System.out.println("람다식 테스트");};
		l.test();
		
		lamda2 l2 = (int a) -> { System.out.println("안녕하세요"+a);};
		l2.test(2);
		...
		lamda4 l4 = a -> a*a; //매개변수가 하나라면 () 생략가능, 코드가 단순 return 문이 끝이면 {} 생략가능
